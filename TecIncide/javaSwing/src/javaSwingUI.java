 ...
 */
public class javaSwingUI extends javax.swing.JFrame {

    /**
     * Creates new form javaSwingUI
     */
    public javaSwingUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(javaSwingUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new javaSwingUI().setVisible(true);
            }
        });
    }
